...
app.post("/recipes/addToFavorite", recipesController.addToFavorite);
app.get("/myfavorite", favoriteController.index);
app.get("/myfavorite/detail/:id", favoriteController.detailFavorite);
